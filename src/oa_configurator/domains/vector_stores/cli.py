...
def vector_stores_add(
    ...
    sqlite_path: Annotated[str | None, typer.Option(help=VectorStoreConfig.model_fields["sqlite_path"].description)] = None,
) -> None:
    r"""Add or update a \[vector_stores.<name>] entry. Prompts for any field not given as a flag."""
    flags = {
        k: v for k, v in {
            "backend_type": backend_type, "database": database, "sqlite_path": sqlite_path,
